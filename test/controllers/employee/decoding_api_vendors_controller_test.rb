...
class Employee::DecodingApiVendorsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  describe '#show' do
    it 'responds successfully' do
      get decoding_api_vendor_url(@decoding, @vendor)
    ...
    it 'handles decoding with multiple projects' do
      ...
      get decoding_api_vendor_url(@decoding, @vendor, format: :csv)
      assert_ok_with_no_warning
    end
    ...
    it 'handles decoding without multiple projects' do
      ...
      get decoding_api_vendor_url(@processed_decoding, @vendor, format: :csv)
      assert_ok_with_no_warning
    end
  end
end
